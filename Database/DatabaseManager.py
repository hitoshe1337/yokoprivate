...
class DataBase:
    ...
    def loadAccount(self):
        ...
        if user_data:
            ...
            self.player.ppp = user_data[0]["info"]["ppp"]
            self.player.ppg = user_data[0]["info"]["ppg"]
            self.player.roborumble = user_data[0]["info"]["roborumble"]
            self.player.bigbrawler = user_data[0]["info"]["bigbrawler"]
            self.player.bossfightlvl = user_data[0]["info"]["bossfightlvl"]
            self.player.powerplayrank = user_data[0]["info"]["powerplayrank"]
            self.player.challenge = user_data[0]["info"]["challenge"]
            ...
            "info":
                {
                    ...
                    "ppp": self.player.ppp,
                    "ppg": self.player.ppg,
                    "roborumble": self.player.roborumble,
                    "bigbrawler": self.player.bigbrawler,
                    "bossfightlvl": self.player.bossfightlvl,
                    "powerplayrank": self.player.powerplayrank,
